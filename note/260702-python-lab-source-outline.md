# Python 실습자료 후속 범위 정리

원본 위치:

`/Users/mumallaeng/Library/CloudStorage/GoogleDrive-yonnmilk@gmail.com/My Drive/Classroom/대한상공회의소_반도체설계/담당강사/상공회의소_KDT_실습자료(C_Python_M4)/2.Python/Py_Lab_for_VS_Code.py`

Python 실습자료는 `Py_Lab_for_VS_Code.py`에 예제 block을 순서대로 모아 둔 구조다. 1장부터 12장까지의 수업 내용은 날짜별 노트로 나누어 정리했고, 이 노트는 원본 예제의 순서와 후반 범위를 한곳에서 다시 찾는 source outline으로 둔다. 보조 모듈은 `my_module.py`, `your_module.py`, `my_package/` 아래에 있으며, 11장 import/package 예제와 연결된다.
...
Python의 `for`는 iterable에서 item을 하나씩 꺼내 target에 binding하는 구조다. target unpack을 사용하면 tuple/list item을 바로 여러 변수로 나눠 받을 수 있다.
...
| 날짜 | 원본 범위 | 연결 노트 |
| :--- | :--- | :--- |
| 26-07-06 | 1장 기본 문법 | [Python 1장 기본 문법, 입력, 문자열 포맷](260706-python-basic-syntax.md) |
| 26-07-07 | 2~4장 object·container | [Python Object Name Binding, Container 구조 및 연산](260707-python-object-name-binding-container-operations.md) |
| 26-07-08 | 5~6장 built-in·사용자 정의 함수 | [Python Built-in 함수와 사용자 정의 함수](260708-python-built-in-functions-user-defined-functions.md) |
| 26-07-09 | 8~10장 comprehension·제어문·container method | [Python Comprehension, 제어문, Container 메서드](260709-python-comprehension-control-flow-container-methods.md) |
| 26-07-10 | 11~12장 exception·module·package·class | [Python Exception, Module, Package, Class](260710-python-exception-module-package-class.md) |
