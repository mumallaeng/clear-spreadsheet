...
`/Users/mumallaeng/Library/CloudStorage/GoogleDrive-yonnmilk@gmail.com/My Drive/Classroom/대한상공회의소_반도체설계/담당강사/상공회의소_KDT_실습자료(C_Python_M4)/3.ARM_Lab`
...
| 위치 | 범위 | 연결 노트 |
| :--- | :--- | :--- |
| 환경 준비 | ARM GCC·ST-LINK·terminal 설정 | [M4 Nucleo GCC Tool 설치 가이드](m4-nucleo-tool-install.md) |
| 전체 지도 | 1~15과의 MCU·firmware 흐름 | [Cortex-M4 Firmware 전체 지도 - 1~15과](cortex-m4-firmware-course-map.md) |
| 26-07-13 | 전자 소자, 임베디드 시스템, STM32F411 | [ARM GCC Toolchain, 전자 소자, 컴퓨터·임베디드 시스템](260713-arm-gcc-electronics-embedded-systems.md) |
| 26-07-14 | GPIO, `volatile`, CMSIS, bit operation | [GPIO, volatile, CMSIS, bit operation](260714-gpio-volatile-cmsis-bit-operations.md) |
| 26-07-15 | LED driver, system clock, key polling | [LED Driver, System Clock, Key](260715-led-driver-system-clock.md) |
| 26-07-16 | UART, debounce, timer 기초 | [ARM Cortex-M4 디바이스 프로그래밍](260716-arm-cortex-m4-device-programming.md) |
| 26-07-20~21 | timer, interrupt, event-driven firmware | [Timer 제어](260720-timer-control.md), [Interrupt·Event-Driven Firmware](260721-interrupt-event-driven.md) |
| 26-07-22~23 | I2C, SPI, ADC, sensor interface | [I2C·SPI Interface](260722-i2c-spi-interface.md), [ADC·Sensor Interface](260723-adc-sensor-interface.md) |
